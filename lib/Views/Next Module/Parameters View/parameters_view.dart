...
class ParametersView extends StatefulWidget {
  ...
  const ParametersView({Key? key, this.factorTitle, this.type})
      : super(key: key);
    ...
    return Consumer<MyState>(
      builder: (context, stateProvider, child) {
        return ValueListenableBuilder(
          valueListenable: HiveBoxes.nextParameterData().listenable(),
          builder: (context, box, _) {
            var data = box.values.toList().cast<NextParameterModel>();
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return
                            data[index].factorTitle == widget.factorTitle ?
                            Padding(
