...
import '../Now List View/now_list_view.dart';

class NowCategories extends StatefulWidget {
  final String now;
  const NowCategories({Key? key, required this.now}) : super(key: key);

  @override
  State<NowCategories> createState() => _NowCategoriesState();
}

class _NowCategoriesState extends State<NowCategories> {
                    ...
                    return Padding(
                      ...
                      child: InkWell(
                        onTap: (){
                          ...
                          Get.to(() =>  NowListView(listTitle: items['title']!));
                        },
                        child: Column(
                          children: [
                            Stack(
